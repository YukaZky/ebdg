...
import 'manual_payments_screen.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  void _openCoupons() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ListKuponScreen()),
    ).then((_) => _fetchDashboardData());
  }
  ...
  void _openStoreIncome() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const PendapatanTokoScreen()),
    ).then((_) => _fetchDashboardData());
  }
  ...
  void _openPayoutManagement() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const PencairanPendapatanScreen()),
    ).then((_) => _fetchDashboardData());
  }

  void _openManualPayments() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ManualPaymentsScreen()),
    ).then((_) => _fetchDashboardData());
  }
                              ...
                              child: Column(
                                children: [
                                  _buildListMenu(
                                    context,
                                    'Informasi Toko',
                                    'Nama, deskripsi, logo, dan sosial media',
                                  ...
                                  _buildListMenu(
                                    context,
                                    'Alamat Toko',
                                    'Atur origin ongkir, kecamatan, dan titik maps toko',
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _buildListMenu(
                                    context,
                                    'Pendapatan Toko',
                                    'Saldo order selesai, info pencairan, dan rekening toko',
                                  ...
                                  if (isSuperAdmin)
                                    _buildListMenu(
                                      ...
                                      'Khusus Super Admin: cairkan saldo pendapatan setiap toko',
                                      Icons.payments_outlined,
                                      Colors.indigo,
                                      true,
                                      _openPayoutManagement,
                                    ),
                                  if (isSuperAdmin)
                                    _buildListMenu(
                                      context,
                                      'Pembayaran User',
                                      'Khusus Super Admin: verifikasi bukti dan kelola VA utama',
                                  ...
                                  _buildListMenu(
                                    context,
                                    'Pesan Pelanggan',
                                    'Lihat dan balas chat yang masuk ke toko ini',
                                    Icons.chat_outlined,
                                    Colors.amber,
                                    true,
                                    _openCustomerMessages,
                                  ),
                                  _buildListMenu(
                                    context,
                                    'Kupon Diskon',
                                    'List, tambah, edit, dan hapus voucher promo',
