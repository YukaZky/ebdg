...
class _StoreProfileScreenState extends State<StoreProfileScreen> {
  ...
  Future<void> _openCoupons() async {
    await Navigator.push(
        context, MaterialPageRoute(builder: (_) => const ListKuponScreen()));
  }
        ...
        child: Row(children: [
          ...
          const Expanded(
            child:
              ...
              Text('Logo / Foto Profil Toko',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
              SizedBox(height: 4),
              Text(
                  'Ketuk untuk upload logo toko. Logo ini akan muncul di detail produk dan halaman toko.',
                  style: TextStyle(
        ...
        child: Row(children: [
          ...
          const Expanded(
            child:
              ...
              SizedBox(height: 4),
              Text(
                  'Kelola list kupon, tambah, edit, detail, dan hapus kupon toko.',
                  style: TextStyle(
                      color: Colors.black54, fontSize: 12, height: 1.35)),
            ]),
          ),
              ...
              child: Form(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      _field('Alamat Toko', _addressCtrl,
                      ...
                      ElevatedButton(
                          ...
                          child: Text(
                              _saving ? 'Menyimpan...' : 'Simpan Profil Toko')),
                    ]),
              ),
            ),
    );
  ...
  Widget _field(String label, TextEditingController controller,
      {bool required = false, int maxLines = 1, bool readOnly = false}) {
    return Padding(
